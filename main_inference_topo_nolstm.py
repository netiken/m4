...
class Inference:
    def __init__(
        ...
        self.linear_rate = torch.jit.script(self.linear_rate.to(self.device))
...
def interactive_inference(
    ...
    while n_flows_completed < n_flows_total_min:
        ...
        if flowid_active_list_cur is not None and flowid_active_list_cur.numel() > 0:
            ...
            time_deltas[:] = time_deltas.max() / 1000.0
...
def main():
    ...
    model_list = [
        ...
        ("new_debug_nolstm", 10, 4000),
        # test
        # ("new_debug_nolstm", 14, 4000),
        # ("new_debug_nolstm", 13, 4000),
        # ("new_debug_nolstm", 12, 4000),
        # ("new_debug_nolstm", 11, 4000),
        # ("new_debug_nolstm", 10, 4000),
        # ("new_debug_nolstm", 9, 4000),
        # ("new_debug_nolstm", 8, 4000),
        # ("new_debug_nolstm", 7, 4000),
        # ("new_debug_nolstm", 6, 4000),
        # ("new_debug_nolstm", 5, 4000),
    ]
    if args.flowsim:
