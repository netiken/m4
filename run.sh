...
git add -A . ; git commit -m "add more feats"; git push
...
python main_train.py --train_config=./config/train_config_lstm.yaml --mode=train --dir_input=/data2/lichenni/path_perflow --dir_output=/data2/lichenni/output_perflow --note fct_path_gnn
...
python main_train.py --test_config=./config/test_config_lstm.yaml --mode=test --note=fct_path_gnn --version_id 0 --dir_input=/data2/lichenni/path_perflow_empirical --dir_output=/data2/lichenni/output_perflow --test_on_empirical

python main_train.py --test_config=./config/test_config_lstm.yaml --mode=test --note=fct_path_gnn --version_id 0 --dir_input=/data2/lichenni/path_perflow --dir_output=/data2/lichenni/output_perflow --test_on_train
