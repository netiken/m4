...
def main():
    ...
    dataset_list = [
        ...
        ("eval_test_large", 3, 80000),
    ]
    model_list = [
        # ("m4", 10, 4000),
        # ("m4", 17, 4000),
        ("final_nosupervision", 19, 4000),
        ("final_nosupervision", 18, 4000),
        ("final_nosupervision", 17, 4000),
        ("final_nosupervision", 16, 4000),
        ("final_nosupervision", 15, 4000),
        ("final_nosupervision", 14, 4000),
        ("final_nosupervision", 13, 4000),
        ("final_nosupervision", 12, 4000),
        ("final_nosupervision", 11, 4000),
        ("final_nosupervision", 10, 4000),
        ("final_nosupervision", 9, 4000),
        ("final_nosupervision", 8, 4000),
        ("final_nosupervision", 7, 4000),
        ("final_nosupervision", 6, 4000),
        ("final_nosupervision", 5, 4000),
        # old
        ...
        # ("final_gnn4", 4, 4000),
        # ("final_gnn4", 3, 4000),
        # ("final_gnn_layer4", 10, 4000),
        # ("final_gnn_layer4", 9, 4000),
        # ("final_gnn_layer4", 8, 4000),
        # ("final_gnn_layer4", 7, 4000),
        # ("final_gnn_layer4", 6, 4000),
        # ("final_gnn_layer4", 5, 4000),
        # new
        # ("final_param", 6, 4000),
        # ("final_large", 5, 4000),
        # ("final_gnn4", 7, 4000),
        ...
        # ("topo_remainsize", 21, 2000),
        # ("topo_remainsize_large", 10, 3000),
