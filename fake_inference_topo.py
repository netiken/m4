...
class Inference:
    def __init__(
        ...
        self.z_t_link[:, 1] = 1.0
        self.z_t_link[:, 2] = 1.0
        self.save_models("./flowsim/model_no_flowsim")
...
def interactive_inference(
    ...
    print(size_tensor.unsqueeze(1).shape, sldn_flowsim_tensor.unsqueeze(1).shape, flowid_to_nlinks.unsqueeze(1).shape, param_data_tensor.shape, h_vec.shape)
    ...
    if args.flowsim:
        ...
        for dataset_str, n_shards, n_flows_total in dataset_list:
            ...
            for model_instance, model_ckpt, model_shard in model_list:
                ...
                checkpoint = "/data2/lichenni/output_perflow/m4_noflowsim_shard4000_nflows1_nhosts1_nsamples1_lr10Gbps/version_0/checkpoints/best.ckpt" #f"{args.output}/{model_instance}_shard{model_shard}_nflows1_nhosts1_nsamples1_lr10Gbps/version_0/checkpoints/{model_name_loaded}.ckpt"
                inference = Inference(
                    data_config,
                    model_config,
                    training_config,
