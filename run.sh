...
python main_train.py --train_config=./config/train_config_lstm.yaml --mode=train --dir_input=/data2/lichenni/path_perflow_link --dir_output=/data2/lichenni/output_perflow --note fct
