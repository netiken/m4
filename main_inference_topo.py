...
def main():
    ...
    model_list = [
        ...
        # ("m4_grunorm_small", 15, 4000),
        # ("m4_grunorm_small", 14, 4000),
        # ("m4_grunorm_small", 13, 4000),
        # ("m4_grunorm_small", 12, 4000),
        # ("m4_grunorm_small", 11, 4000),
        # ("m4_grunorm_small", 10, 4000),
        # ("m4_grunorm_small", 9, 4000),
        # ("m4_grunorm_small", 8, 4000),
        # ("m4_grunorm_small", 7, 4000),
        # ("m4_grunorm_small", 6, 4000),
        ...
        # ("m4_grunorm_mid", 12, 4000),
        # ("m4_grunorm_mid", 11, 4000),
        # ("m4_grunorm_mid", 10, 4000),
        # ("m4_grunorm_mid", 9, 4000),
        # ("m4_grunorm_mid", 8, 4000),
        # ("m4_grunorm_mid", 7, 4000),
        # ("m4_grunorm_mid", 6, 4000),
        # ("m4_grunorm_mid", 5, 4000),
