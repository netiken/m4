...
git add -A . ; git commit -m "path dataset"; git push
...
python main_train.py --train_config=./config/train_config_lstm.yaml --mode=train --dir_input=/data2/lichenni/path_perflow_link --dir_output=/data2/lichenni/output_perflow --note fct_log_v1_pos
...
python main_train.py --test_config=./config/test_config_lstm.yaml --mode=test --note=fct_log_v1_pos --version_id 0 --dir_input=/data2/lichenni/path_perflow_link_empirical --dir_output=/data2/lichenni/output_perflow --test_on_empirical

python main_train.py --test_config=./config/test_config_lstm.yaml --mode=test --note=fct_log_v1_pos --version_id 0 --dir_input=/data2/lichenni/path_perflow_link --dir_output=/data2/lichenni/output_perflow --test_on_train
