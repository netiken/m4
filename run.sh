...
python main_train.py --test_config=./config/test_config_lstm_topo.yaml --mode=test --version_id 0 --dir_input=/data1/lichenni/projects/per-flow-sim/parsimon-eval/expts/fig_8/eval_test_trace_debug --dir_output=/data2/lichenni/output_perflow --test_on_empirical --note=new_debug
