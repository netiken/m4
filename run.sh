...
git add -A . ; git commit -m "new training"; git push
...
python main_link.py --train_config=./config/train_config.yaml --mode=train --dir_input=/data2/lichenni/path_perflow --dir_output=/data2/lichenni/output_perflow --note fct_baseline
