...
static constexpr uint64_t SERVER_OVERHEAD_NS = 100000; // 400 us between recv and send
...
int main(int argc, char* argv[]) {
    ...
    *index_ptr = 0;
    ...
    const int default_ops = 650 * NUM_CLIENTS; // total ops (will be divided across clients)
