...
def main():
    ...
    model_list = [
        ...
        ("new_debug_notime", 10, 4000),
        # test
        # ("new_debug_notime", 14, 4000),
        # ("new_debug_notime", 13, 4000),
        # ("new_debug_notime", 12, 4000),
        # ("new_debug_notime", 11, 4000),
        # ("new_debug_notime", 10, 4000),
        # ("new_debug_notime", 9, 4000),
        # ("new_debug_notime", 8, 4000),
        # ("new_debug_notime", 7, 4000),
        # ("new_debug_notime", 6, 4000),
        # ("new_debug_notime", 5, 4000),
    ]
    if args.flowsim:
